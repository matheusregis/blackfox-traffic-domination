...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Salva token e busca o user no contexto
      login(token);
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-dark flex items-center justify-center p-6">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-primary-glow/10 rounded-full blur-3xl animate-glow-pulse"
          ...
          <Card className="bg-card/50 border-primary/20 shadow-glow">
            <CardHeader className="space-y-1 text-center">
              ...
              <CardDescription className="text-muted-foreground">
                Crie sua conta Cloaker Guard e comece a proteger seus anúncios
                hoje
              </CardDescription>
            </CardHeader>
            <CardContent>

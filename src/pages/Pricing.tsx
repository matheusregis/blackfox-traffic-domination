...
import { Check, Star, ArrowLeft, Globe } from "lucide-react";
...
export default function Pricing() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="sticky top-0 z-50 border-b bg-background/90 backdrop-blur supports-[backdrop-filter]:bg-background/70">
      ...
      {/* Conteúdo de planos */}
      <section id="pricing" className="py-16 md:py-24 bg-gradient-dark">
